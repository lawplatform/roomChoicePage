...
const Card_Radio = ({ name, meta, setMeta }: Card_RadioProps) => {
	...
	return (
		<div className="flex flex-row  sm:flex-col-reverse  items-center card  my-2 mx-1 sm:mx-1 py-1 pb-3  sm:h-30 w-72 sm:w-96 border-2 border-black-200 rounded-lg" onClick={handleClick}>
